...
template <class Object>
Vector<Object>::const_iterator cbegin() const{
...
template <class Object>
Vector<Object>::const_iterator cend() const{
...
template <class Object>
const_iterator & Vector<Object>::operator++(){
    ++m_ptr;
    return this;
}
